...
synth_design -top shiftleds_muxVioIla -part xc7a35ticsg324-1L
...
write_checkpoint -force -noxdef shiftleds_muxVioIla.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file shiftleds_muxVioIla_utilization_synth.rpt -pb shiftleds_muxVioIla_utilization_synth.pb"  } 
