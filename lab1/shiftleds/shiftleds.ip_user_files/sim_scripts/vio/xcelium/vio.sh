...
#
# Script generated by Vivado on Mon Sep 29 01:54:04 CEST 2025
...
#
# Usage        : vio.sh
#                vio.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio.sh [-reset_run]
#                vio.sh [-reset_log]
#                vio.sh [-help]
#
...
#                script (type 'vio.sh -help' for more information).
#
...
# script info
echo -e "vio.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../shiftleds.gen/sources_1/bd/vio/ipshared/814a/hdl/verilog" +incdir+"../../../../shiftleds.gen/sources_1/bd/vio/ipshared/1017/hdl/verilog" +incdir+"../../../../shiftleds.gen/sources_1/bd/vio/ipshared/4506/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.vio xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.vio -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/pdietz/Desktop/FPGA/Laboratorio/Lab1/shiftleds/shiftleds.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log vio_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: vio.sh [-reset_log]\n\
Usage: vio.sh [-keep_index]\n\
