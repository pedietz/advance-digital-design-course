...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila xil_defaultlib.ila xil_defaultlib.glbl -log elaborate.log
}
